# -*- coding: utf-8 -*-
"""Ce fichier contient la classe carte ainsi que les fonctions nécessaires à l'enregistrement, création et uilisation de cartes """ 
class Map():
